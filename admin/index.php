        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item <?php
                                        echo $activeNav === "unpaid" ? "active" : "";

                                        ?>">
                        <a class="nav-link" href="?page=unpaid">
                            <i class="menu-icon mdi mdi-cart-off"></i>
                            <span class="menu-title">Unpaid</span>
                        </a>
                    </li>
                    <li class="nav-item <?php
                                        echo $activeNav === "konfirmasi" ? "active" : "";

                                        ?>">
                        <a class="nav-link" href="?page=konfirmasi">
                            <i class="menu-icon mdi mdi-cash-multiple"></i>
                            <span class="menu-title">Confirm Payment</span>
                        </a>
                    </li>
                    <li class="nav-item <?php
                                        echo $activeNav === "paid" ? "active" : "";

                                        ?>">
                        <a class="nav-link" href="?page=paid">
