...
$paidpage = isset($_GET["paidpage"]) ? $_GET["paidpage"] : "paid";
if ($paidpage === "detail") {
    detailData();
} else {
    getData();
...
function getData()
{
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM pemesanan JOIN film on pemesanan.id_film = film.id_film JOIN jadwal on pemesanan.id_jadwal = jadwal.id_jadwal WHERE `status`='paid'");
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a href="?page=paid&paidpage=detail&id_pesan=<?php echo $q["id_pemesanan"] ?>"><i class="mdi mdi-eye " style="font-size: 20px;"></i></a>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                ?>
                    <a href="./cetak.php?id_pesan=<?php echo $data->id_pemesanan ?>" class="btn btn-primary"> See Ticket</a>
                <?php  } else {
                ?>
